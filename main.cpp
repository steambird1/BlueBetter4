...
// They're so useful that everyone needs them
...
__const__		Indicate if the variable is a constant.
__is_prop__		For a function, showing if it is a property.
__setter__		For a function, showing its property setter.
